        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-black tracking-tight dark:text-gray-100 flex items-center gap-3 italic">
                    <i data-lucide="shopping-cart" class="w-8 h-8 text-primary"></i> Nueva Venta
                </h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 font-medium tracking-tight">Elegí productos, ajustá
                    precios si hace falta, y cobrá.</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white dark:bg-dark-alt rounded-[32px] border border-gray-100 dark:border-white/5 shadow-sm p-4 md:p-5">
                        ...
                        @include('partials.barcode-scanner', ['placeholder' => 'Escaneá un producto para agregarlo a la venta...', 'autofocus' => false])
                    </div>
                                    ...
                                    <div @click="addProduct(product.id); search = ''; searchOpen = false"
                                        ...
                                        <div>
                                            ...
                                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">
                                                ...
                                                <span x-text="`${product.stock} DISPONIBLES`"></span>
                                            </p>
                                        </div>
                                        <div
                    ...
                    <div
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="sale-client-select" name="client_id" x-model="selectedClientId" data-placeholder="Buscar cliente..."
