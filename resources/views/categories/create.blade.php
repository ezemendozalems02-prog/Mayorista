        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-black tracking-tight dark:text-gray-100 flex items-center gap-3">
                    <i data-lucide="folder-plus" class="w-8 h-8 text-primary"></i> Nueva Categoría
                </h1>
                <p class="text-sm text-gray-500 dark:text-gray-400 font-medium">Organizá el catálogo por categorías y subcategorías.</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required autofocus
                            ...
                            placeholder="Ej: Juguetería">
                        @error('name') <p class="text-[10px] text-red-500 font-bold ml-1">{{ $message }}</p> @enderror
                    </div>

                    <div class="space-y-2">
                        <label class="text-xs font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest ml-1">Slug (opcional)</label>
