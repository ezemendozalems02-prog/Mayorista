...
<head>
    ...
    <title>Recuperar Clave - {{ config('platform.brand.name') }}</title>
    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <div
            ...
            <div class="mb-8 text-center">
                <h1 class="text-2xl font-black text-white mb-2">¿Olvidaste tu clave?</h1>
            ...
            <div class="mt-8 pt-8 border-t border-white/5 text-center">
                <p class="text-xs font-bold text-gray-400 tracking-tight">
                    ¿Te acordaste de tu clave? <a href="{{ route('login') }}" class="text-primary hover:underline">Volver al login</a>
                </p>
            </div>
